                ...
                <div class="c-i-section">
                    @foreach ($partners as $key=>$p)
                        <div class="c-i-list">
                            ...
                            <form id="c-i-forms-{{$key+1}}" method="post" action={{ route('cms-partners') }} class="c-i-form a-i-form" enctype="multipart/form-data">                            
                                {{ csrf_field() }}        
                                <input name="_method" type="hidden" value="PUT">                                 
                                <input type="hidden" name="id" value={{$p->id}}>                                
                                <input type="hidden" name="last_icon" value={{$p->icon}}>                                
                                <input type="text" name="company" placeholder="Company" value="{{$p->company}}">
                    ...
                    <div class="c-i-list">
                        ...
                        <form id="c-i-add-forms" method="post" action={{ route('cms-partners') }} class="c-i-form client-i-form" enctype="multipart/form-data">
                            {{ csrf_field() }}                                                                                                                                
